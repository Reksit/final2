        ...
        <div class="max-w-2xl mx-auto">
          <div class="flex items-center gap-4 py-8">
            ...
            <div>
              ...
              <p class="text-gray-600">Update your task with AI-powered roadmap generation</p>
            </div>
          </div>
                ...
                <div class="form-group">
                  ...
                  <div *ngIf="taskData.roadmap" class="bg-gray-50 rounded-lg p-4 border">
                    ...
                    <div class="prose prose-sm max-w-none">
                      <pre class="whitespace-pre-wrap font-sans text-sm text-gray-700 leading-relaxed">{{ taskData.roadmap }}</pre>
                    </div>
                  </div>
                  ...
                  <div *ngIf="!taskData.roadmap && !isGeneratingRoadmap" class="text-center py-8 text-gray-500">
                    ...
                    <p class="text-xs">Fill in the title and description, then click "Generate AI Roadmap"</p>
                  </div>
                </div>
